...
def TaskExe():
    ...
    def Music():
        ...
        if 'gajanana' in musicName:
            os.startfile('Music\\Gajanana.mp3')

        elif 'krishna' in musicName:
            os.startfile('Music\\Woh-Krishna-Hai.mp3')
    ...
    def Reader():
        ...
        if 'india' in name:
            ...
            os.startfile('Book\\india.pdf')
            book = open('Book\\india.pdf','rb')
        ...
        elif 'Wings of fire' in name:
            os.startfile('Book\\Wings of fire by Abdul Kalam.pdf')
            book = open('Book\\Wings of fire by Abdul Kalam.pdf','rb')
            pdfreader = PyPDF2.PdfFileReader(book)
            pages = pdfreader.getNumPages()
            Speak(f"Number Of Pages In This Books Are {pages}")
            Speak("From Which Page I Have To Start Reading ?")
    ...
    while True:
        ...
        if 'hello' in query:
            ...
            TakeHindi()
                ...
                # Speak("I do not get you Sir,Please speak again")
